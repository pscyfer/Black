...
{
    Task<string> RenderToStringAsync(string viewName, object model, ViewContext context);
}
...
public class RenderViewToString : IRenderViewToString
{
    ...
    public async Task<string> RenderToStringAsync(string viewName, object model, ViewContext context)
    {
