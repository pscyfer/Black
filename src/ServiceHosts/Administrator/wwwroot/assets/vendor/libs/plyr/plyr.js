          ...
          "object" == typeof navigator &&
            (e.exports = (function () {
                  ...
                  check(e, t, i) {
                    ...
                    return {
                      ...
                      ui:
                        n &&
                        he.rangeInput &&
                        ("video" !== e || !W.isIPhone || s),
                    };
                  },
                  pip: !(
                    W.isIPhone ||
                    (!_(X("video").webkitSetPresentationMode) &&
              ...
              function Ae(e) {
                return (
                  !!(O(e) || (L(e) && e.includes(":"))) &&
                  (O(e) ? e : e.split(":")).map(Number).every(I)
                );
              }
              function Se(e) {
                        ...
                        if (e.quality !== t) {
                          if (
                            ...
                            const i = xe.getSources
                              .call(e)
                              .find(
                                (e) => Number(e.getAttribute("size")) === t
                              );
                            if (!i) return;
                            const {
                              currentTime: s,
              ...
              const Fe = {
                  ...
                  return (
                    n.toggle
                      ? (a.appendChild(
                        ...
                        a.appendChild(
                          Fe.createIcon.call(this, n.icon, {
                ...
                timeUpdate(e) {
                  const t =
                    !D(this.elements.display.duration) &&
                ...
                setCaptionsMenu() {
                  ...
                  const n = i.map((e, i) => ({
                    ...
                    badge:
                      e.language &&
                      Fe.createBadge.call(this, e.language.toUpperCase()),
                    list: t,
                    type: "language",
                  }));
                  n.unshift({
                ...
                create(e) {
                  ...
                  const c = X(
                    "div",
                    te(this.config.selectors.controls.wrapper)
                  );
                  this.elements.controls = c;
                  const h = { class: "plyr__controls__item" };
                  return (
                    we(
                      O(this.config.controls) ? this.config.controls : []
                    ).forEach((l) => {
                      if (
                        ("restart" === l &&
                    ...
                    this.isHTML5 &&
                      l.call(this, xe.getQualityOptions.call(this)),
                    o.call(this),
                    c
                  );
                },
                  ...
                  i.forEach((e) => {
                    ...
                    a &&
                      (t.addEventListener("mouseenter", () => {
                        e.label ||
                          ((a.style.left = i), (a.innerHTML = e.label), o(!0));
                      }),
              ...
              const Ue = {
                  setup() {
                    ...
                    if (
                      ($(n) || ({ active: n } = this.config.captions),
              ...
              class Je {
                      ...
                      if (this.enabled)
                        if (W.isIos && this.player.config.fullscreen.iosNative)
                          this.target.webkitExitFullscreen(),
                            ve(this.player.play());
                        else if (!Je.native || this.forceFallback)
                ...
                get enabled() {
                  return (
                    (Je.native || this.player.config.fullscreen.fallback) &&
                ...
                get active() {
                  ...
                  if (!Je.native || this.forceFallback)
                    return ne(
                      this.target,
                      this.player.config.classNames.fullscreen.fallback
                    );
                ...
                build() {
                  if ((this.listeners.media(), !this.supported.ui))
                    return (
                      ...
                      void Ze.toggleNativeControls.call(this, !0)
                    );
                  D(this.elements.controls) ||
                    ...
                    this.poster &&
                      Ze.setPoster.call(this, this.poster, !1).catch(() => {}),
                        ...
                        (t) => {
                          ...
                          s === i.container &&
                            ((!e.isEmbed && V(e.config.ratio)) ||
                              (n(),
                              ("enterfullscreen" === t.type ? pe : me).call(
                                e,
                                window,
                                "resize",
                                a
                    ...
                    e(this, "media", () => {
                      ...
                      if (
                        ...
                        pe.call(
                          ...
                          (t) => Ze.checkPlaying.call(e, t)
                        ),
                        pe.call(
                          e,
                          e.media,
                          "waiting canplay seeked playing",
                          (t) => Ze.checkLoading.call(e, t)
                        ),
                    ...
                    e(this, "controls", () => {
                      ...
                      this.bind(
                        ...
                        this.bind(
                          ...
                          (t) => Fe.updateSeekTooltip.call(e, t)
                        ),
                ...
                ready() {
                  ...
                  t.customControls ||
                    De(Ne(e.config.urls.vimeo.api, d)).then((t) => {
                      !V(t) &&
                        t.thumbnail_url &&
                        Ze.setPoster.call(e, t.thumbnail_url).catch(() => {});
                    }),
                    ...
                    this.media
                      ? (se(
                        ...
                        this.isHTML5
                          ...
                          : this.isYouTube
                          ? ot.setup.call(this)
                          : this.isVimeo && nt.setup.call(this))
                ...
                constructor(t) {
                  e(this, "load", () => {
                    ...
                    e(this, "startScrubbing", (e) => {
                      (x(e.button) || !1 === e.button || 0 === e.button) &&
                        ((this.mouseDown = !0),
                        this.player.media.duration &&
                      ...
                      this.destroy.call(
                        ...
                        () => {
                          ...
                          Object.assign(this, {
                            ...
                            this.isHTML5 &&
                              mt.insertElements.call(this, "source", t),
                            (this.config.title = e.title),
                            rt.setup.call(this),
                            this.isHTML5 &&
                              Object.keys(e).includes("tracks") &&
                              mt.insertElements.call(this, "track", e.tracks),
                            (this.isHTML5 ||
                            ...
                            V(e.previewThumbnails) ||
                              ...
                              this.config.previewThumbnails.enabled &&
                                (this.previewThumbnails = new pt(this))),
              ...
              class gt {
                constructor(t, i) {
                  if (
                    ...
                    e(this, "pause", () =>
                      this.playing && _(this.media.pause)
                        ? this.media.pause()
                        : null
                    ),
                    e(this, "togglePlay", (e) =>
                      ($(e) ? e : !this.playing) ? this.play() : this.pause()
                    ),
                    e(this, "stop", () => {
                      this.isHTML5
                    ...
                    e(this, "destroy", (e, t = !1) => {
                      ...
                      this.stop(),
                        ...
                        this.isHTML5
                          ? (Ze.toggleNativeControls.call(this, !0), i())
                          : this.isYouTube
                ...
                set muted(e) {
                  let t = e;
                  $(t) || (t = this.storage.get("muted")),
                    $(t) || (t = this.config.muted),
                    (this.config.muted = t),
                    (this.media.muted = t);
                }
                get muted() {
                ...
                set download(e) {
                  F(e) &&
                    ...
                    Fe.setDownloadUrl.call(this));
                }
                set poster(e) {
                  this.isVideo
                    ? Ze.setPoster.call(this, e, !1).catch(() => {})
                ...
                set ratio(e) {
                  this.isVideo
                    ? L(e) && Ae(e)
                      ? ((this.config.ratio = Se(e)), Pe.call(this))
                      : this.debug.error(
                ...
                static setup(e, t = {}) {
                  ...
                  return (
                    L(e)
                      ...
                      ? (i = Array.from(e))
                      : O(e) && (i = e.filter(D)),
                    V(i) ? null : i.map((e) => new gt(e, t))
                  );
                }
              }
              var ft;
              return (
                (gt.defaults = ((ft = We), JSON.parse(JSON.stringify(ft)))), gt
              );
            })());
        },
      },
