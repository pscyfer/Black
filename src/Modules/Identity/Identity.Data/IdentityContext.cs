...
{
    public class IdentityContext : IdentityDbContext<User, Role, Guid, UserClaim, UserRole, IdentityUserLogin<Guid>,
    RoleClaim, IdentityUserToken<Guid>>, IUnitOfWork
    {
        ...
        public virtual void DetachLocal<TEntity>(TEntity entity, string entryId) where TEntity : BaseEntity
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));

            var local = base.Set<TEntity>()
                .Local
